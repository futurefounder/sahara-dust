      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap -m-4">
            ...
            <div className="h-full text-center">
              <p className="italic leading-relaxed">
                ...
                <span className="font-bold">
                  &quot; The particles can be breathed in and enter your lungs
                  and blood stream,
                </span>
          ...
          <div className="p-4 mb-6 lg:w-1/3 lg:mb-0">
            <div className="h-full text-center">
              <p className="leading-relaxed">
                ...
                Mediterranean and Euro-Atlantic region in winters
                2020–2022.&quot;
              </p>
              <span className="inline-block w-10 h-1 mt-6 mb-4 rounded bg-amber-500"></span>
              <p className="text-gray-100">
          ...
          <div className="p-4 lg:w-1/3 lg:mb-0">
            <div className="h-full text-center">
              <p className="italic leading-relaxed">
                &quot;Our results provide evidence of: (1) the role of Saharan
                Dust as an independent risk factor for adverse respiratory
                effect in The Canary Islands; (2) the existence of a short-term
